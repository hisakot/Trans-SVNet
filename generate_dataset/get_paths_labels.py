...
# dir_names = ["20170707main":1, "20200214_1main":2, "20200214_2main":3,
#             "20220405assistant":4, "20220422main":5,
#             "20220628main":6, "20220715main":7]
root_dir2 = '../../Dataset/surgery/'
img_dir2 = os.path.join(root_dir2, 'org_imgs')
...
phase_dict = {}
phase_dict_key = ['Before_Incision', 'Flap', # 'Lymph_Node',
                  'Mammary_Gland_Pealing',
                  'Cleaning', 'Skin_Suture', 'Other']
...
for j in range(len(phase_file_names2)):
    ...
    video_num_file = int(os.path.splitext(os.path.basename(phase_file_paths2[j]))[0][0:1]) # CHANGED
    ...
    for phase_line in phase_file:
        ...
        if int(phase_split[0]) % downsample_rate == 0:
            ...
            img_file_each_path = os.path.join(
                    img_dir_paths2[j], str(phase_split[0]).zfill(6) + '.png') # CHANGED
